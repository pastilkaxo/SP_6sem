...
extern const MIDL_SERVER_INFO ILVO_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ILVO_ProxyInfo;
...
/* Object interface: ILVO, ver. 1.0,
   GUID={0xA7F2B8F3,0x95D2,0x4D7B,{0xA1,0xCC,0x3A,0x20,0xD8,0x76,0x9A,0xC6}} */

#pragma code_seg(".orpc")
static const unsigned short ILVO_FormatStringOffsetTable[] =
    {
    36
    };

static const MIDL_STUBLESS_PROXY_INFO ILVO_ProxyInfo =
    {
    &Object_StubDesc,
    IComTest__MIDL_ProcFormatString.Format,
    &ILVO_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ILVO_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    IComTest__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(4) _ILVOProxyVtbl = 
{
    &ILVO_ProxyInfo,
    &IID_ILVO,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* ILVO::PowerOfN */
};

const CInterfaceStubVtbl _ILVOStubVtbl =
{
    &IID_ILVO,
    &ILVO_ServerInfo,
    4,
...
const CInterfaceProxyVtbl * const _IComTest_ProxyVtblList[] = 
{
    ...
    ( CInterfaceProxyVtbl *) &_ILVOProxyVtbl,
    0
};
...
const CInterfaceStubVtbl * const _IComTest_StubVtblList[] = 
{
    ...
    ( CInterfaceStubVtbl *) &_ILVOStubVtbl,
    0
};
